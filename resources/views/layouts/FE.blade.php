...
<head>
    ...
    <title>{{ config('app.store_name', 'Online Store') }}</title>
    <meta name="description" content="{{ config('app.store_name', 'Online Store') }} Online Store">
    <meta name="keywords"
        content="tailwind,tailwindcss,tailwind css,css,starter template,free template,store template, shop layout, minimal, monochrome, minimalistic, theme, nordic">

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <link rel="stylesheet" href="{{ Vite::asset('resources/css/wp.css') }}" />
    ...
    <script src="https://kit.fontawesome.com/61b1a17030.js" crossorigin="anonymous"></script>
    ...
    <nav id="header" class="w-full z-30 top-0 py-1">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div class="order-1 md:order-2">
                <a class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl space-x-1"
                    href="{{ url('/') }}">
                    <div>
                        <img src="{{ Vite::asset('resources/images/logo-trans.png') }}" alt="Logo Warung Teteh"
                            width="75" height="75">
                    </div>
                    {{-- <div>
                        {{ config('app.store_name', 'Online Store') }}
                    </div> --}}
                </a>
            </div>
            ...
            <div class="order-2 md:order-3 flex items-center" id="nav-content">
                ...
                @if (!request()->routeIs('checkout'))
                    <livewire:front-end.cart @cartUpdated="$refresh" />
                @endif
            ...
            <div class="w-full mx-auto flex flex-wrap">
                <div class="flex w-full lg:w-1/2 ">
                    <div class="px-3 md:px-0">
                        <ul>
                            <li>
                                <a class="inline-block hover:text-black hover:underline py-2 px-4
                                {{ request()->routeIs('tnc') ? 'underline' : 'no-underline' }}
                            "
                                    href="{{ route('tnc') }}">
                                    Terms & Conditions
                                </a>
                            ...
                            <li>
                                <a class="inline-block hover:text-black hover:underline py-2 px-4
                                {{ request()->routeIs('privacy-policy') ? 'underline' : 'no-underline' }}
                            "
